...
$(document).ready( function(){
	...
	if( $(".judgesSlider").length) {
		$('.judgesSlider').owlCarousel({
			 loop:true
			// ,autoplay:true
			// ,autoplayTimeout:3000
			// ,smartSpeed:1200
	...
	if( $(".datesSlider").length) {
		$('.datesSlider').owlCarousel({
			 loop:true
			// ,autoplay:true
			// ,autoplayTimeout:3000
			// ,smartSpeed:1200
	...
	if( $(".functionalitiesSlider").length) {
		$('.functionalitiesSlider').owlCarousel({
			 loop:true
			// ,autoplay:true
			// ,autoplayTimeout:3000
			// ,smartSpeed:1200
